...
if C["datatext"].classcolor then
	hexa = string.format("|c%02x%02x%02x%02x", 255, T.colors.class[T.myclass][1] * 255, T.colors.class[T.myclass][2] * 255, T.colors.class[T.myclass][3] * 255)
end
...
--local font = [[Interface\Addons\EpicUI\media\HelveticaNeueLTCom-Cn.ttf]]
local fontflag = "THINOUTLINE" -- for pixelfont stick to this else OUTLINE or THINOUTLINE
...
--local band = bit.band
--local font = [[Interface\AddOns\ElvUI\media\fonts\Homespun.ttf]] -- HOOG0555.ttf 
